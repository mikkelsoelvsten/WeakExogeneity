...
saving = 1;
f1Name = 'Figures\biasFigure_LargeT';
f2Name = 'Figures\biasFigureOLSIV_LargeT';
f3Name = 'Figures\biasFigureOLS_LargeT';
f31Name = 'Figures\biasFigureOLSTr_LargeT';
f4Name = 'Figures\biasBoundsFigure_LargeT';
f5Name = 'Figures\biasBoundsFigureLargeL_LargeT';
f6Name = 'Figures\biasBoundsFigureOLS_LargeT';
f7Name = 'Figures\biasBoundsFigureIV_LargeT';

workspaceName = 'SimulationsForSection2_LargeT.mat';

%% Simulations varying number of regressors (K)

% Setup for this simulation
% Number of parameters
Kvec = 4*[4,6,8,10,12,14,16,18,20,30,40,50,60,70,80,90,100];
lK = length(Kvec);
...
%% Simulations varying the autocorrelation in regressors
...
for k = 1:5+2*Sb
    SumKi(k,:) = polyval( polyfit(Kvec,SumK(:,k),5), Kveci);
end
...
for k = 1:5+2*Sb
    SumRHOi(k,:) = polyval( polyfit(RHOvec,SumRHO(:,k),5), RHOveci);
end
